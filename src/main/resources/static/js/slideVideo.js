...
function SlideBarVideo(data){
	var _this = this;
	var oActionBlock = document.getElementById(data.actionBlock1);
	var oActionBar = document.getElementById(data.actionBar1);
	var oSlideBar = document.getElementById(data.slideBar1);
	var barLength = data.barLength1;
	var interval = data.interval1;
	var maxNumber = data.maxNumber1;
	var oShowArea = null;
	if(data.showArea1){
		oShowArea = document.getElementById(data.showArea1);	
	}
